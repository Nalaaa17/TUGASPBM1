...
/// Typography system — Neo-Brutalism Comic Style
/// Font utama: Bangers (comic), Nunito (body), Space Grotesk (heading)
class AppTextStyles {
  AppTextStyles._();

  // ── Display (Bangers — Gaya Komik Penuh) ──────────────
